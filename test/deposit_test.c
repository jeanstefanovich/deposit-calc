...
CTEST(Validation_test, srok_30_OK_sum_1000000_OK_expections_OK)
{
...
CTEST(Validation_test, srok_60_OK_sum_100000_OK_expections_OK)
{
...
CTEST(Validation_test, srok_60_OK_sum_1000000_OK_expections_OK)
{
...
CTEST(Validation_test, srok_121_OK_sum_1000000_OK_expections_OK)
{
...
CTEST(Validation_test, srok_240_OK_sum_1000000_OK_expections_OK)
{
...
CTEST(Validation_test, srok_241_OK_sum_100000_OK_expections_OK)
{
...
CTEST(Validation_test, srok_365_OK_sum_1000000_OK_expections_OK)
{
...
CTEST(Validation_test, srok_365_OK_sum_100000_OK_expections_FAIL)
{
    const int result = deposit(365,100000);
    const int expected = 1150000;
    ASSERT_EQUAL(expected, result);
